...
<!-- Begin CV body -->
<body class="cv-light-grey" style="box-sizing: border-box;width: 100%;"> 

<!-- Page Container -->
<div class="content cv-margin-top" style="max-width:30000px;margin: 20px auto;padding: 0 5px;width: 100%;">
  ...
  <div id="Profile" class="container cv-white cv-card tab" style="display: block;">
    <h2>Profile</h2>
    <div class="container cv-text-grey cv-card-4">
